...
with st.form("form"):
    time_alone = st.slider("Time spent alone (0-15)", 0, 15, 5)
    event_attend = st.slider("Attendance at social events (0-15)", 0, 15, 5)
    going_out = st.slider("Frequency of going out (0-15)", 0, 15, 5)
    friend_circle = st.slider("Size of social circle (0-15)", 0, 15, 5)
    post_freq = st.slider("Frequency of posting on social media (0-15)", 0, 15, 5)
